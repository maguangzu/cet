...
<script>
	...
	{
		document.forms[0].action="findallactive.do?page="+num;
...
<body>
<h1>所有进行中活动</h1>
<form action="findallactive.do" method="post">
	活动编号：<input type="text" placeholder="活动编号" name="active_id" value="">
	<input type="submit" value="查询活动信息" />
</form>

<table width="70%" cellpadding="0" cellspafindmyactivecing="0" border="1">
	<tr>
		<th>序号</th>
		<th>活动编号</th>
		<th>活动名称</th>
	...
	<c:forEach items="${requestScope.allactivepage.list}" var="at" varStatus="aa">
		<tr>
			...
			<td><a href="joinactive.do?activeid=${at.activeid}">加入</a></td>
		</tr>
	</c:forEach>
